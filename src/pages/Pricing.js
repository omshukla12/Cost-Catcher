...
const PricingTier = ({ name, price, features, isPopular }) => (
  <motion.div
    ...
    className={`bg-white rounded-lg p-8 shadow-lg ${isPopular ? 'border-2 border-orange-500' : ''}`}
  >
    {isPopular && (
    ...
    <p className="text-4xl font-bold mb-6">${price}<span className="text-lg font-normal text-gray-600">/month</span></p>
    ...
    <motion.button
      ...
      className={`w-full py-2 px-4 rounded-md text-lg font-semibold ${
        isPopular ? 'bg-orange-500 text-white hover:bg-orange-600' : 'bg-gray-200 text-gray-800 hover:bg-gray-300'
        ...
        >
          ...
          <div className="max-w-3xl mx-auto space-y-8">
            ...
            <div>
              ...
              <p className="text-gray-600">We offer a 14-day free trial for our Pro plan. No credit card required.</p>
            </div>
            <div>

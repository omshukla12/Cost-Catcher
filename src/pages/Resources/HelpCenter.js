...
export default function HelpCenter() {
  ...
  const categories = [
    ...
    },
    {
      ...
      icon: ChevronRight,
      articles: [
        "Why isn't my price alert working?",
      ...
      <main className="container mx-auto px-4 py-16">
        ...
        >
          ...
          <p className="text-xl text-gray-600 mb-8">
            Our support team is here to help. Reach out to us through any of the
            following channels:
          </p>
          <div className="flex flex-col md:flex-row justify-center items-center space-y-4 md:space-y-0 md:space-x-8">
            <a
              href="#"
              className="flex items-center text-orange-500 hover:text-orange-600 transition-colors duration-300"
            >
            ...
            <a
              href="mailto:support@costcatcher.com"
              className="flex items-center text-orange-500 hover:text-orange-600 transition-colors duration-300"
            >
              <Mail className="mr-2" />
            ...
            {[
              {
                ...
                answer:
                  "Our AI-powered price predictions are highly accurate, with a typical margin of error less than 5%. We continuously refine our algorithms to improve accuracy.",
              },
              {
                question: "Can I track prices from any online store?",
                answer:
                  "Cost-Catcher supports price tracking for most major online retailers. If you find a store that's not supported, please let us know, and we'll work on adding it.",
              },
              {
                question: "How often are prices updated?",
                answer:
                  "Prices are typically updated every 6 hours. For high-demand items or during sales events, we may increase the frequency to ensure you don't miss any deals.",
              },
              {
                question: "Is there a limit to how many items I can track?",
                answer:
                  "Free accounts can track up to 10 items simultaneously. Premium accounts have unlimited tracking capabilities.",
              },
            ].map((faq, index) => (
              <motion.div
                key={index}

...
const EditAccountDetails = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        `${process.env.REACT_APP_CC_API}/editAccountDetails/${accountId}`,
        {
          method: "PUT",
          headers: {
        ...
        >
          <div className="flex-1 grid gap-6">
            <div className="grid gap-1">
              <label className="text-sm py-2 font-medium" htmlFor="name">
                Name
              </label>
              <input
            ...
            <div className="grid gap-1">
              <label className="text-sm py-2 font-medium" htmlFor="email">
                Email
              </label>
              <input
                className="flex h-10 w-full rounded-md border px-3 py-2 text-sm"
            ...
            <div className="grid gap-1">
              <label className="text-sm py-2 font-medium" htmlFor="phone">
                Whatsapp Number
              </label>
              <input
                className="flex h-10 w-full rounded-md border px-3 py-2 text-sm"
            ...
            <div className="flex gap-4">
              ...
              <a
                href="/account"
                className="inline-flex items-center justify-center w-1/2 bg-white text-black border border-black rounded-md text-sm font-medium h-10 px-4 py-2"
              >
                Cancel
              </a>
            </div>
